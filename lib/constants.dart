import 'package:flutter/material.dart';
  ...
  const kBottomTextStyle = TextStyle(fontSize: 20,fontWeight: FontWeight.w700, letterSpacing: 2);

  const kYourResultTextStyle =  TextStyle(fontSize: 40, fontWeight: FontWeight.w500);

  const kResultTextStyle = TextStyle(fontSize: 25, fontWeight: FontWeight.w700, color: Colors.green, letterSpacing: 5);

  const kBMIResult = TextStyle(fontSize: 50, fontWeight: FontWeight.bold);
